...
public class Employee {
    ...
    public Employee(int id, String name, String dateOfBirth, String idCard, double salary, String phoneNumber, String email, String address, int educationDegreeId, int positionId, int divisionId) {
        this.id = id;
        this.name = name;
        this.dateOfBirth = dateOfBirth;
        this.idCard = idCard;
    ...
    public Employee(String name, String dateOfBirth, String idCard, double salary, String phoneNumber, String email, String address, int educationDegreeId, int positionId, int divisionId) {
        this.name = name;
        this.dateOfBirth = dateOfBirth;
        this.idCard = idCard;
        this.salary = salary;
