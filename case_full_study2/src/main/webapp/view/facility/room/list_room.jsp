...
<div align="center">
    <table id="tableStudent" class="table table-striped table-bordered" style="width:100%" border="1">
        ...
        <tr>
            ...
            <th style="text-align: center">FACILITY FREE</th>
<%--            <th style="text-align: center">ACTION</th>--%>
        ...
        <c:forEach var="room" items="${listRoom}">
            <tr>
                ...
                <td style="text-align: center"><c:out value="${room.area}"/></td>
                <td style="text-align: center"><c:out value="${room.cost}"/></td>
                <td style="text-align: center"><c:out value="${room.max_people}"/></td>
                <td style="text-align: center"><c:out value="${room.rent_type}"/></td>
                <td style="text-align: center"><c:out value="${room.facility_free}"/></td>
<%--                <td>--%>
<%--                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"--%>
<%--                            data-bs-target="#exampleModal${room.name}">--%>
<%--                        Xoá--%>
<%--                    </button>--%>

<%--                    <!-- Modal -->--%>
<%--                    <div class="modal fade" id="exampleModal${room.name}" tabindex="-1"--%>
...
<%--                                    Bạn có muốn xoá user có name là <strong class="text-danger">${room.name}</strong>--%>
<%--                                    không ?--%>
<%--                                </div>--%>
<%--                                <div class="modal-footer">--%>
<%--                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close--%>
<%--                                    </button>--%>
<%--                                    <a href="/users?action=delete&id=${room.name}" class="btn btn-secondary">Delete</a>--%>
<%--                                </div>--%>
<%--                            </div>--%>
<%--                        </div>--%>
<%--                    </div>--%>
