...
<%--                </ul>--%>
            ...
            <li class="list__item d-flex justify-content-center align-items-center">
                <a href="/employees?action=page">Employee</a>

            </li>
            <li class="list__item d-flex justify-content-center align-items-center"><a href="/customers?action=page">Customer</a></li>
