    ...
    <div class="wrapper h-100 d-flex ">
        <ul class="list d-flex text-bg-light">
            <li class="list__item d-flex justify-content-center align-items-center">
                <a href="#">List the service</a>
                <ul class="sub__list d-flex flex-column bg-light shadow">
                    <li><a style="width: 100%; display: inline-block" href="/villas?action=listVilla"
                           target="_blank"><input
                            style="width: 100%; display: inline-block"
                            type="button" value="List Villa"></a></li>
                    <li><a style="width: 100%; display: inline-block" href="/rooms?action=listRoom"
                           target="_blank"><input
                            style="width: 100%; display: inline-block"
                            type="button" value="List Room"></a></li>
                    <li><a style="width: 100%; display: inline-block" href="/houses?action=listHouse"
                           target="_blank"><input
                            style="width: 100%; display: inline-block"
                            type="button" value="List House"></a></li>
                </ul>
            </li>
            <li class="list__item d-flex justify-content-center align-items-center">
                <a href="#">Add new service</a>
                <ul class="sub__list d-flex flex-column bg-light shadow">
                    <li><a style="width: 100%; display: inline-block" href="/villas?action=addVilla"
                           target="_blank"><input
                            style="width: 100%; display: inline-block"
                            type="button" value="ADD Villa"></a></li>
                    <li><a style="width: 100%; display: inline-block" href="/houses?action=addHouse"
                           target="_blank"><input
                            style="width: 100%; display: inline-block"
                            type="button" value="ADD House"></a></li>
                    <li><a style="width: 100%; display: inline-block" href="/rooms?action=addRoom"
                           target="_blank"><input
                            style="width: 100%; display: inline-block"
                            type="button" value="ADD Room"></a></li>
                </ul>
                </a>
            </li>
            <li class="list__item d-flex justify-content-center align-items-center">
                ...
                <ul class="sub__list d-flex flex-column bg-light shadow">
                    <li><a style="width: 100%; display: inline-block" href="/villas?action=editVilla"
                           target="_blank"><input
                            style="width: 100%; display: inline-block"
                            type="button" value="EDIT Villa"></a></li>
