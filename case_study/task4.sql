...
-- yêu cầu 5
SELECT kh.ma_khach_hang, kh.ho_ten, lk.ten_loai_khach, hd.ma_hop_dong, dv.ten_dich_vu, hd.ngay_lam_hop_dong, hd.ngay_ket_thuc,(ifnull(dv.chi_phi_thue,0)+SUM(ifnull(hdct.so_luong,0)*ifnull(dvdk.gia,0))) AS tong_tien FROM hop_dong hd LEFT JOIN khach_hang kh ON hd.ma_khach_hang = kh.ma_khach_hang 
